alias ss='cd ~/.ssh'
alias s='~/dotfiles/scripts/ssh_aws.bash'
...
alias scour='~/dotfiles/scripts/scour.bash'
alias ns='cd ~/appropos/envoy-web/server && ./bin/run-dev-server'
alias o='~/dotfiles/scripts/next_rebase_file.bash'
alias fd='~/dotfiles/scripts/next_git_diff_file.bash'
alias fa='~/dotfiles/scripts/next_git_add_file.bash'
alias fr='~/dotfiles/scripts/next_git_checkout_file.bash'
alias fo='~/dotfiles/scripts/next_git_ours_file.bash'
alias cf='~/dotfiles/scripts/next_vs_code_file.bash'
alias ef='~/dotfiles/scripts/next_emacs_file.bash'
...
alias cof='bash ~/dotfiles/scripts/checkout_feature.bash'
