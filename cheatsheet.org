...
* TODO Moonlander keyboard!
 - [X]  Ordered!
consier mapping alt-{ instead of alt-shift-{ to line hopper
or better yet, it doesn't look like alt-i and alt-k do anything productive; map those!
 - [X]  map hyper-s to Slack.
 - [ ]  1** Need to version control aerospace.toml!!!
Toy with lights
